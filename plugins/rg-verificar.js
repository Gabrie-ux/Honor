...
let handler = async function (m, { conn, text, args, usedPrefix, command }) {
    ...
    let perfil = await conn.profilePictureUrl(whe, 'image').catch(_ => 'https://qu.ax/TDAld.jpg')
    ...
    let [_, name, splitter, age] = 9text.match(Reg)
...
┗━━━━━━━━━━━━━━━━━━⬣\n`
  ...
  await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
            externalAdReply: {
                title: '⊱『✅𝆺𝅥 𝗥𝗘𝗚𝗜𝗦𝗧𝗥𝗔𝗗𝗢(𝗔) 𝆹𝅥✅』⊰',
                thumbnailUrl: 'https://f.uguu.se/ePueJeUt.jpg',
                mediaType: 1,
...
⤷ ${sn}`;
    ...
    let channelID = '120363419364337473@newsletter';
