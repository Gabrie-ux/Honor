...
let handler = async (m, { conn, isROwner, text }) => {
    ...
    if (conn.user.jid === conn.user.jid) {
        const progreso = [
      "*🕒 iniciando proceso de reinicio de hayabu*",
            "□□□□□□ 0%",
            "■□□□□□ 20%",
            "■■□□□□ 30%",
            "■■■□□□ 50%",
        ...
        await conn.sendMessage(m.chat, { text: "✅ hayabu reiniciado con éxito espera unos segundos asta que el proceso termine.", edit: key }, { externalAdReply: { title: botname, body: dev, sourceUrl: channel });
