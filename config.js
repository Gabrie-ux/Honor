...
global.packname = '【✧】hayabu bot -MD❖'
global.botname = '(✦◠‿◠)hayabubot -𝑴𝑭'
global.wm = '⏤͟͟͞͞⋆⬪࣪ꥈ🍨★ ׄ ꒱ hayabubot- 𝑴.𝑭 ୭'
global.author = '(⁎˃ᴗ˂⁎)һᥲᥡᥲᑲᥙ ᥲі𓆪'
global.dev = '© ⍴᥆ᥕᥱrᥱძ ᑲᥡ һᥲᥡᥲᑲᥙ ᥲі'
global.espera = '✰ 𝐄𝐬𝐩𝐞𝐫𝐚 𝐔𝐧 𝐌𝐨𝐦𝐞𝐧𝐭𝐨, 𝐄𝐬𝐭𝐚𝐦𝐨𝐬 𝐄𝐧𝐯𝐢𝐚𝐧𝐝𝐨 𝐒𝐮 𝐏𝐞𝐝𝐢𝐝𝐨 (✿◠‿◠)'
global.namebot = 'һᥲᥡᥲᑲᥙ'
global.textbot = `「 🍀 hayubu- 𝐌𝐅 🍷 」`
global.vs = '2.2.0'
...
//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*
global.repobot = 'https://github.com/Gabrie-ux/Honor.git'
global.grupo = 'https://chat.whatsapp.com/FeWfraCmhn0BFtRatwm7oM'
global.gteam = 'https://chat.whatsapp.com/FeWfraCmhn0BFtRatwm7oM'
...
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "51941658 192-120363418214675829@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '👑【✫𝗍ᥱᥲm һᥲᥡᥲᑲᥙ ᑲ᥆𝗍✫】🎩', orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}
